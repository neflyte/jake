...
/**
  ...
  @param {Object} [opts]
    @param {Array} [opts.async=false] Perform this task asynchronously.
    If you flag a task with this option, you must call the global
    `complete` method inside the task's action, for execution to proceed
    to the next task.
    @param {Array} [opts.syncPrereqs=false] Perform this task's prerequisites synchronously.
 */
Task = function () {
